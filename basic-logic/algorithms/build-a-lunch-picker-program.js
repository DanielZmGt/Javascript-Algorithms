...
const lunches = []
  ...
  export const addLunchToEnd = (arr, item) => {
  arr.push(item);
console.log(`${item} added to the end of the lunch menu.`);
  return arr
  }

  export const addLunchToStart = (arr, item) => {
  arr.unshift(item);
console.log(`${item} added to the start of the lunch menu.`);
  return arr
  }

  export const removeLastLunch = (arr) => {if (arr.length > 0) {
console.log(`${arr.pop()} removed from the end of the lunch menu.`);
} else console.log("No lunches to remove.")
  return arr
  };

   export const removeFirstLunch = (arr) => {if (arr.length > 0) {
console.log(`${arr.shift()} removed from the start of the lunch menu.`);
} else console.log("No lunches to remove.")
  return arr
  }

   export const getRandomLunch = (arr) => {if (arr.length > 0)
     {
     ...
     export const showLunchMenu = (arr) => {
